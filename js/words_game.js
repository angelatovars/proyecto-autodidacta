const niveles = {
  1: {
    anagramas: ["ORERP", "OGAT", "OLRO", "EPZ"],
    palabras: ["PERRO", "GATO", "LORO", "PEZ"],
    puntajeCorrecto: 2,
    puntajeError: -1,
  },
  2: {
    anagramas: ["CCAINOUDE", "OMUSE", "QPRAUE", "EOCHC"],
    palabras: ["EDUCACION", "MUSEO", "PARQUE", "COCHE"],
    puntajeCorrecto: 4,
    puntajeError: -2,
  },
  3: {
    anagramas: ["VANOI", "ETLAERSLA", "ATÑOMNA", "MLFAIAI"],
    palabras: ["AVION", "ESTRELLA", "MONTAÑA", "FAMILIA"],
    puntajeCorrecto: 6,
    puntajeError: -3,
  },
};
...
function mostrarAnagrama() {
  document.getElementById("anagrama").innerText =
    niveles[nivelActual].anagramas[palabraActual];
}

// Verificar si la respuesta es correcta
document
  .getElementById("validarRespuesta")
...
function volverAlMenu(event) {
  ...
  if (!visitado.includes("words_game")) {
